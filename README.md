...
Sunflower's [plant details screen](app/src/main/java/com/google/samples/apps/mygarden/PlantDetailFragment.kt)
is built with Compose as well as the [plant list item](app/src/main/java/com/google/samples/apps/mygarden/compose/plantlist/PlantListItemView.kt)
view within a `RecyclerView`.

All Compose code can be found in the `compose`
[folder](app/src/main/java/com/google/samples/apps/mygarden/compose).
...
[PlantDetailView file](app/src/main/java/com/google/samples/apps/mygarden/compose/plantdetail/PlantDetailView.kt).
