...
android {
  ...
  defaultConfig {
    applicationId = "com.google.samples.apps.mygarden"
    minSdk = libs.versions.minSdk.get().toInt()
    targetSdk = libs.versions.targetSdk.get().toInt()
    testInstrumentationRunner = "com.google.samples.apps.mygarden.utilities.MainTestRunner"
    versionCode = 1
    versionName = "0.1.6"
  ...
  namespace = "com.google.samples.apps.mygarden"
}
